...
Model weights could be found [n the website](https://huggingface.co/Qwen/Qwen3-32B)
...
Model weights could be found [on the websiteo](https://huggingface.co/Qwen/Qwen3-30B-A3B)
