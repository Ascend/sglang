...
W4A8 Model weights could be found [on the website](https://modelers.cn/models/Modelers_Park/DeepSeek-R1-0528-w4a8).
...
<<<<<<< HEAD:docs/platforms/ascend_npu_deepseek_example.md
    ```shell
    export PYTORCH_NPU_ALLOC_CONF=expandable_segments:True
    export STREAMS_PER_DEVICE=32
...
python -m sglang.launch_server \
    ...
    --tokenizer-worker-num 4
```
>>>>>>> f30df723bf146d4a8037010b0b11939a601df423:docs/platforms/ascend/ascend_npu_deepseek_example.md
...
W8A8 Model weights could be found [on the website](https://modelers.cn/models/State_Cloud/Deepseek-R1-bf16-hfd-w8a8).
