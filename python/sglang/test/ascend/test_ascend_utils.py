...
LLAMA_2_7B_CHAT_HF_WEIGHTS_PATH = os.path.join(
    MODEL_WEIGHTS_DIR, "NousResearch/Llama-2-7b-chat-hf"
)
LLAMA_2_7B_CHAT_HF_EAGLE_WEIGHTS_PATH = os.path.join(
    MODEL_WEIGHTS_DIR, "lmsys/sglang-EAGLE-llama2-chat-7B"
)
