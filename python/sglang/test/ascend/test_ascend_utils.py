...
QWEN3_5_4B_MCAT_LORA_PATH = os.path.join(MODEL_WEIGHTS_DIR, "jamezoon/qwen3.5-4b-mcat-lora")
QWEN3_5_4B_NEO4J_TEXT2CYPHER_LORA_PATH = os.path.join(MODEL_WEIGHTS_DIR, "Aswinkv07/qwen3.5-4b-neo4j-text2cypher-lora")
