...
class LoRAModelCase:
    ...
    rouge_l_tolerance: float =1.0  #没有默认值，必须手动传入
...
LORA_MODELS_QWEN3 = [
    LoRAModelCase(
        base="/home/weights/Qwen/Qwen3-4B",
        adaptors=[
            LoRAAdaptor(
                name="/home/weights/Qwen/Qwen3-4B-lora-v2",
                prefill_tolerance=3e-1,
            ),
            LoRAAdaptor(
                name="/home/weights/Qwen/Qwen3-4B-LoRA-ZH-WebNovelty-v0.0",
                prefill_tolerance=3e-1,
            ),
        ],
        max_loras_per_batch=2,
