...
class TestNPUMiniMaxM2_5W8A8_8P_In64k_Out1k_Prefix90_50ms(TestAscendPerfMultiNodePdSepTestCaseBase):
    """MiniMax-M2.5-w8a8 PD Sep 64k input 1k output with 90% prefix cache performance test"""
    ...
    def test_npu_minimax_m2_5_w8a8_8p_in64k_out1k_prefix90_50ms(self):
        """Run MiniMax-M2.5-w8a8 PD Sep 64k/1k prefix90 performance test"""
        self.run_throughput()
