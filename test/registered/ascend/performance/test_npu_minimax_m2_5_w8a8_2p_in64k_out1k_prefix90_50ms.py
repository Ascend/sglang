...
MINIMAX_M2_5_W8A8_IN64K_OUT1K_PREFIX90_ENVS = {
...
MINIMAX_M2_5_W8A8_IN64K_OUT1K_PREFIX90_OTHER_ARGS = [
    "--tp-size",
    8,
    "--enable-dp-attention",
...
class TestNPUMiniMaxM2_5W8A8_2P_In64k_Out1k_Prefix90_50ms(TestAscendPerformanceTestCaseBase):
    ...
    other_args = MINIMAX_M2_5_W8A8_IN64K_OUT1K_PREFIX90_OTHER_ARGS
    envs = MINIMAX_M2_5_W8A8_IN64K_OUT1K_PREFIX90_ENVS
    dataset_name = "random"
    max_concurrency = 64
    num_prompts = 200
    input_len = 64000
