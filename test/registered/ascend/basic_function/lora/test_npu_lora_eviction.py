...
ADAPTERS = [
    CODE_LLAMA_3_1_8B_TEXT_TO_SQL_LORA_PATH,  # target_modules = q, v
    VALADAPT_LLAMA_3_1_8B_CHINESE_LORA_PATH,  # target_modules = q, k, v, o, gate, up, down
]
...
class TestLoRAEviction(CustomTestCase):
    ...
    def _run_test(
        ...
        base_path = LLAMA_3_1_8B_INSTRUCT_WEIGHTS_PATH
