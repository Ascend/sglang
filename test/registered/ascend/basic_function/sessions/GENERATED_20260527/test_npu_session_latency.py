...
register_npu_ci(est_time=122, suite="nightly-2-npu-a3", nightly=True)
...
class TestNPUSessionLatency(CustomTestCase):
    """Test streaming session inter-turn latency on NPU.

    [Test Category] Performance
    [Test Target] StreamingSession latency optimization
    """
