...
class TestNPUKimiK2_5_W4A8_16P_AIME2025(TestAscendAccuracyMultiNodePdMixTestCaseBase):
    """Test NPU accuracy for Kimi-K2.5-w4a8 16p PD Mix on AIME 2025"""
    ...
    def test_npu_kimi_k2_5_w4a8_16p_aime2025(self):
        """Run NPU accuracy test for Kimi-K2.5-w4a8 16p PD Mix on AIME 2025"""
        self.run_accuracy()
