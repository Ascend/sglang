...
register_npu_ci(est_time=3200, suite="full-4-npu-a3", nightly=True, disabled="The environment cleanup failed, causing the ports for the later test cases to be occupied.")
