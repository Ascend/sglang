...
class TestPrefillDelayerHighWatermark(CustomTestCase):
    def test_empty_scheduler_passes_do_not_decay_high_watermark(self):
        high_watermark = 64.0
    ...
    def test_actual_admission_decays_and_updates_high_watermark(self):
        self.assertAlmostEqual(
            update_max_prefill_bs_high_watermark(
                64.0, admitted_prefill_bs=16
            ),
            63.872,
        )
        self.assertEqual(
