...
class TestNpuTrainInferenceConsistencyTP4(CustomTestCase):
    """Testcase：Using sglang.test.test_deterministic, verified that with parallelism strategies enabled, training-inference consistency
